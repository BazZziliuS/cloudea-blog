...
* **[Aeza](https://aeza.net/?ref=507375)** — хостинг (регион: Frankfurt, тариф: `Shared1`)
* **Домен** — куплен на [Aeza](https://aeza.net/?ref=507375)
...
Сочетание **[Aeza](https://aeza.net/?ref=507375)**, **[Tailscale](https://tailscale.com)** и **[n8n](https://n8n.io/)** позволяет запускать полноценные автоматизации у себя дома с публичным доступом по HTTPS — при этом без аренды дорогого VPS и полного контроля за всей системой.
